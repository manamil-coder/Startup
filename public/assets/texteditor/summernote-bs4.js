  ...
  $$1.extend($$1.summernote.lang, {
      'en-US': {
          ...
          image: {
              ...
              resizeNearlyFull: 'Resize Nearly full',
  ...
  */
  ...
  var Buttons = /** @class */ (function () {
      ...
      Buttons.prototype.addImagePopoverButtons = function () {
		  ...
		  this.context.memo('button.resizeNearlyFull', function () {
              return _this.button({
                  contents: '<span class="note-fontsize-10">75%</span>',
                  tooltip: _this.lang.image.resizeNearlyFull,
  ...
  $$1.summernote = $$1.extend($$1.summernote, {
      ...
      options: {
          ...
          popover: {
              image: [
                  ['resize', ['resizeFull', 'resizeNearlyFull', 'resizeHalf', 'resizeQuarter', 'resizeNone']],
                  ['float', ['floatLeft', 'floatRight', 'floatNone']],
                  ['remove', ['removeMedia']],
              ],
              link: [
          ...
          fontNames: [
              ...
              'Tahoma', 'Times New Roman', 'Verdana', 'font-urdu', 'font-arabic1', 'font-arabic2', 'font-arabic3',
          ],
          fontNamesIgnoreCheck: [],
          fontSizes: ['8', '9', '10', '11', '12', '14', '18', '20', '22', '28', '36', '40'],
    ...
    $.extend($.summernote.plugins, {
        ...
        'rtl': function(context) {
            ...
            context.memo('button.rtl', function() {
                ...
                var button = ui.button({
                    contents: '<i class="fa fa-paragraph" style="min-width:auto;" /><i class="fa fa-caret-left"  style="min-width:auto;" />',
        ...
        'ltr': function(context) {
            ...
            context.memo('button.ltr', function() {
                // create button
                var button = ui.button({
                    contents: '<i class="fa fa-caret-right" style="min-width:auto;"/><i class="fa fa-paragraph" style="min-width:auto;"/>',
